## Agnes Node
Agnes Node is a system that will control all of the connected actuators and sensors. This node can collect farm data (data acquisition) to assist farmers in leading lives of greater productivity, profitability, and lower input costs.
